...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      programs: Table & { Row: { id: string; slug: string; title: string; description: string | null; status: string; sort_order: number; created_at: string; updated_at: string }; Insert: { id?: string; slug: string; title: string; description?: string | null; status?: string; sort_order?: number; created_at?: string; updated_at?: string }; Update: { id?: string; slug?: string; title?: string; description?: string | null; status?: string; sort_order?: number; updated_at?: string } };
      program_enrollments: Table & { Row: { id: string; user_id: string; program_id: string; status: string; enrolled_at: string; completed_at: string | null }; Insert: { id?: string; user_id: string; program_id: string; status?: string; enrolled_at?: string; completed_at?: string | null }; Update: { id?: string; user_id?: string; program_id?: string; status?: string; enrolled_at?: string; completed_at?: string | null } };
      courses: Table & { Row: { id: string; slug: string; title: string; description: string | null; thumbnail_url: string | null; status: string; created_at: string; updated_at: string; program_id: string }; Insert: { id?: string; slug: string; title: string; description?: string | null; thumbnail_url?: string | null; status?: string; created_at?: string; updated_at?: string; program_id: string }; Update: { id?: string; slug?: string; title?: string; description?: string | null; thumbnail_url?: string | null; status?: string; updated_at?: string; program_id?: string } };
