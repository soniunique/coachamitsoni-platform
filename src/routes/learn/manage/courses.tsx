...
function CourseManager() {
  ...
  return <LearnShell>
    ...
    {enrolledProgramIds.size > 0 && <div className="learn-card mb-5 border border-amber-400/30 bg-amber-400/10 p-4 text-sm text-amber-200"><div className="font-semibold">Enrolled program history is protected</div><p className="mt-1 leading-6">Programs with enrollment records, and all courses inside them, cannot be deleted. You can still edit or archive them.</p></div>}
