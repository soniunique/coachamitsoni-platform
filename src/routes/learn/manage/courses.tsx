...
function CourseManager() {
  ...
  return <LearnShell>
    <SectionHeader eyebrow="Admin" title="Programs & Courses" description="Programs contain courses. Student access is granted at the program level and automatically covers every course inside it." action={isAdmin ? <div className="flex flex-wrap gap-2"><button type="button" className="learn-secondary-button" onClick={openCreateProgram}><Plus size={17}/>New program</button><button type="button" className="learn-primary-button" onClick={() => openCreateCourse()} disabled={programs.length === 0}><Plus size={17}/>New course</button></div> : undefined} />
