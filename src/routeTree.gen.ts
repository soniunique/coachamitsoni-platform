...
import { Route as LearnAssessmentsRouteImport } from './routes/learn/assessments'
import { Route as LearnAssessmentsSlugRouteImport } from './routes/learn/assessments.$slug'
...
import { Route as LearnManagePaymentsRouteImport } from './routes/learn/manage/payments'
...
const LearnAssessmentsRoute=LearnAssessmentsRouteImport.update({id:'/learn/assessments',path:'/learn/assessments',getParentRoute:()=>rootRouteImport}as any)
const LearnAssessmentsSlugRoute=LearnAssessmentsSlugRouteImport.update({id:'/learn/assessments/$slug',path:'/learn/assessments/$slug',getParentRoute:()=>rootRouteImport}as any)
...
const LearnManagePaymentsRoute=LearnManagePaymentsRouteImport.update({id:'/learn/manage/payments',path:'/learn/manage/payments',getParentRoute:()=>rootRouteImport}as any)
...
export interface RootRouteChildren {IndexRoute:typeof IndexRoute;LearnCoursesRoute:typeof LearnCoursesRoute;LearnCourseDetailRoute:typeof LearnCourseDetailRoute;LearnAssessmentsRoute:typeof LearnAssessmentsRoute;LearnAssessmentsSlugRoute:typeof LearnAssessmentsSlugRoute;LearnForgotPasswordRoute:typeof LearnForgotPasswordRoute;LearnHelpRoute:typeof LearnHelpRoute;LearnLoginRoute:typeof LearnLoginRoute;LearnMessagesRoute:typeof LearnMessagesRoute;LearnNotificationsRoute:typeof LearnNotificationsRoute;LearnProfileRoute:typeof LearnProfileRoute;LearnRegisterRoute:typeof LearnRegisterRoute;LearnResetPasswordRoute:typeof LearnResetPasswordRoute;LearnWorkshopsRoute:typeof LearnWorkshopsRoute;LearnIndexRoute:typeof LearnIndexRoute;LearnManageCoursesRoute:typeof LearnManageCoursesRoute;LearnManageEnrolmentsRoute:typeof LearnManageEnrolmentsRoute;LearnManagePaymentsRoute:typeof LearnManagePaymentsRoute;LearnManageCourseContentCourseIdRoute:typeof LearnManageCourseContentCourseIdRoute;LearnManageCourseStudentsCourseIdRoute:typeof LearnManageCourseStudentsCourseIdRoute;LearnManageWorkshopRegistrationsRoute:typeof LearnManageWorkshopRegistrationsRoute;LearnManageWorkshopsRoute:typeof LearnManageWorkshopsRoute;LearnManageChatroomsRoute:typeof LearnManageChatroomsRoute;LearnManageAnnouncementsRoute:typeof LearnManageAnnouncementsRoute}
const rootRouteChildren={IndexRoute,LearnCoursesRoute,LearnCourseDetailRoute,LearnAssessmentsRoute,LearnAssessmentsSlugRoute,LearnForgotPasswordRoute,LearnHelpRoute,LearnLoginRoute,LearnMessagesRoute,LearnNotificationsRoute,LearnProfileRoute,LearnRegisterRoute,LearnResetPasswordRoute,LearnWorkshopsRoute,LearnIndexRoute,LearnManageCoursesRoute,LearnManageEnrolmentsRoute,LearnManagePaymentsRoute,LearnManageCourseContentCourseIdRoute,LearnManageCourseStudentsCourseIdRoute,LearnManageWorkshopRegistrationsRoute,LearnManageWorkshopsRoute,LearnManageChatroomsRoute,LearnManageAnnouncementsRoute}
