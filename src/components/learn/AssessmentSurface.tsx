...
function StudentAssessment({ slug, isAdmin }: { slug: string; isAdmin: boolean }) {
  ...
  const hasAttemptsRemaining = !latest?.passed || assessment.max_attempts == null || latest.attempt_number < assessment.max_attempts;
  const canStart = completion?.can_start !== false && hasAttemptsRemaining;
